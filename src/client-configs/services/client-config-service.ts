...
export class ClientConfigService {
  ...
  getBranding = computed(() => this._initialConfig()?.branding);
  getUserInfo = computed(() => this._initialConfig()?.userInfo);
  getToken = computed(() => this._initialConfig()?.token);
  getAsideInfo = computed(() => this._initialConfig()?.asideBar);
  getAppearance = computed(() => this._initialConfig()?.appearance);
